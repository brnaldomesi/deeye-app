        ...
        <View style={[gStyle.bgWhite]}>
            ...
            {sourceType === "Video" ? (
              ...
              <TouchableOpacity>
                ...
                {sourceType === 'MissingPerson' && 
                  <>
                    <Image style={[styles.badge, gStyle.resizeContain, gStyle.absolute]} source={IMAGES_PATH.verifiedBadge} />
                    <LinearGradient 
                    ...
                    >
                      <Text style={gStyle.textWhite}>{'Missing ' + (getDiffFromToday(formData.missing_post.missing_since) === undefined ? '' : getDiffFromToday(formData.missing_post.missing_since)) + ' Now'}</Text>
                    </LinearGradient>
                  </>
                }
              </TouchableOpacity>
          ...
          <View style={gStyle.p1}>
            ...
            <View style={[gStyle.pl1, gStyle.mtp5]}>
              {sourceType === 'MissingPerson' ? (
                <>
                  <Text style={[gStyle.textXl, gStyle.fontWeightBold, gStyle.primaryColor]}>{formData.missing_post.fullname}</Text>
